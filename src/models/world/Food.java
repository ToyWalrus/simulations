...
public class Food implements IConsumable {
	...
	public void growthTick() {
		if (!grows || ticksPassed > ticksUntilFullyGrown)
			return;
	...
	/**
	 * Gets the nutrition amount stored in this food. This will be used to sate the
	 * hunger stat.
	 */
	@Override
	...
	public double getEnergyGainPerTick() {
		return energyGainPerTick;
	}

	public double getNutritionGainPerTick() {
		return nutritionGainPerTick;
	}

	public double getMaxPossibleEnergy() {
		return grows ? energyGainPerTick * ticksUntilFullyGrown : energy;
	}

	public double getMaxPossibleNutrition() {
		return grows ? nutritionGainPerTick * ticksUntilFullyGrown : nutrition;
	}
}
